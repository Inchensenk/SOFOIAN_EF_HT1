...
namespace SOFOIAN_EF_HT1
{
    public class MyDbContext : DbContext
    {
       ...
       public DbSet<OrderModel> Orders { get; set; } = null!;
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=PIXEL; Database=SOF_EF_HT1; Trusted_Connection=True; Encrypt=false") ;
        }
        ...
        private void OnUserCreated(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderModel>().ToSqlQuery("USE Orders GO" +
                                                         "UPDATE Orders" +
                                                         "SET Date = '2022-05-21'" +
                                                         "WHERE Id=30");

            modelBuilder.Entity<OrderModel>().ToSqlQuery("UPDATE Orders" +
                                                         "SET Date = '2022-03-22'" +
                                                         "WHERE Id=31");
